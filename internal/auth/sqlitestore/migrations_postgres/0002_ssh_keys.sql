CREATE TABLE ssh_keys (
    ...
    FOREIGN KEY (scope_tenant, scope_repo) REFERENCES repos(tenant, name) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED
);
...
INSERT INTO schema_version (version, applied_at) VALUES (2, EXTRACT(EPOCH FROM now())::bigint);
