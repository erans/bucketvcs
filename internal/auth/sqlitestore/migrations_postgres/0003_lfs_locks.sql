...
CREATE TABLE lfs_locks (
    ...
    owner_user_id   TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
...
INSERT INTO schema_version (version, applied_at) VALUES (3, EXTRACT(EPOCH FROM now())::bigint);
